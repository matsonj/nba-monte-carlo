...
WITH cte_step_1 AS (
    ...
    LEFT JOIN '/tmp/storage/playoff_sim_r1.parquet' EH ON S.home_team = EH.seed AND R.scenario_id = EH.scenario_id
    LEFT JOIN '/tmp/storage/playoff_sim_r1.parquet' EV ON S.visiting_team = EV.seed AND R.scenario_id = EV.scenario_id
