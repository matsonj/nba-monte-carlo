  ...
  create view "main"."playoff_sim_r3__dbt_tmp" as (
...
WITH cte_step_1 AS (
    ...
    LEFT JOIN '/tmp/storage/playoff_sim_r2.parquet' EH ON S.home_team = EH.seed AND R.scenario_id = EH.scenario_id
    LEFT JOIN '/tmp/storage/playoff_sim_r2.parquet' EV ON S.visiting_team = EV.seed AND R.scenario_id = EV.scenario_id
