  ...
  create  table
    "main_export"."playoff_sim_r2__dbt_tmp"
  as (
...
WITH cte_step_1 AS (
    ...
    LEFT JOIN  "main"."main_export"."playoff_sim_r1" EH ON S.home_team = EH.seed AND R.scenario_id = EH.scenario_id
    LEFT JOIN  "main"."main_export"."playoff_sim_r1" EV ON S.visiting_team = EV.seed AND R.scenario_id = EV.scenario_id
