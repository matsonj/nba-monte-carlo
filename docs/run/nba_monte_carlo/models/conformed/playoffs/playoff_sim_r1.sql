  ...
  create  table
    "main_main"."playoff_sim_r1__dbt_tmp"
  as (
...
WITH cte_step_1 AS (
    ...
    LEFT JOIN  "main"."main_main"."initialize_seeding" EH ON S.home_team = EH.seed AND R.scenario_id = EH.scenario_id
    LEFT JOIN  "main"."main_main"."initialize_seeding" EV ON S.visiting_team = EV.seed AND R.scenario_id = EV.scenario_id
