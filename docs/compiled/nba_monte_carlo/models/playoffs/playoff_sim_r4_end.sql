...
),  __dbt__cte__playoff_sim_r1_end as (
...
WHERE S.type <> 'reg_season'
GROUP BY ALL
),  __dbt__cte__playoff_sim_r2 as (


-- depends-on: __dbt__cte__playoff_sim_r1_end
...
-- depends-on: __dbt__cte__playoff_sim_r2
...
LEFT JOIN __dbt__cte__xf_series_to_seed XF ON XF.series_id = E.series_id
WHERE E.series_result = 4
),  __dbt__cte__playoff_sim_r3 as (


-- depends-on: __dbt__cte__playoff_sim_r2_end
...
-- depends-on: __dbt__cte__playoff_sim_r3
...
LEFT JOIN __dbt__cte__xf_series_to_seed XF ON XF.series_id = E.series_id
WHERE E.series_result = 4
),  __dbt__cte__playoff_sim_r4 as (


-- depends-on: __dbt__cte__playoff_sim_r3_end
...
ORDER BY step2.scenario_id, 
    step2.series_id, 
    step2.game_id
)-- depends-on: __dbt__cte__playoff_sim_r4
