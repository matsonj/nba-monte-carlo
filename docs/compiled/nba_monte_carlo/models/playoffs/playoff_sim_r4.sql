WITH  __dbt__cte__playoff_sim_r3_end as (
...
WHERE E.series_result = 4
    ...
    FROM "main"."main"."schedules" S
        ...
        LEFT JOIN __dbt__cte__playoff_sim_r3_end EH ON S.home_team = EH.seed AND R.scenario_id = EH.scenario_id
        LEFT JOIN __dbt__cte__playoff_sim_r3_end EV ON S.visiting_team = EV.seed AND R.scenario_id = EV.scenario_id
